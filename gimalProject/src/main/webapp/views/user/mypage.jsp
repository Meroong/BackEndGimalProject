...
<head>
    ...
    <style>
        ...
        .log-btn, .mypage-btn, .update-btn, .delete-btn {
            padding:8px 20px; border-radius:10px; border:none; cursor:pointer; font-weight:600;
        ...
        /* ================= 프로필 이미지 영역 ================= */
        .profile-box {
            width: 150px; height:150px; margin-bottom:15px; border-radius:50%; overflow:hidden; border:2px solid #aaa;
        }
        .profile-box img { width:100%; height:100%; object-fit:cover; }

        .profile-actions { display:flex; gap:10px; margin-bottom:15px; }
        .profile-actions button { flex:1; padding:8px 10px; border-radius:8px; border:none; cursor:pointer; font-weight:600; }
...
<section class="main-box">
    ...
    <div class="grid-3">
        ...
        <%-- 가운데, 오른쪽 영역 (예비) --%>
        <div class="map-card" style="display:flex; justify-content:center; align-items:center; color:#666;">추가 통계 또는 최근 활동 영역</div>
        <div class="weather-card" style="display:flex; justify-content:center; align-items:center; color:#666;">알림 및 추천 활동 영역</div>
