                    ...
                    <div class="card dream-card h-100" onclick="location.href='/item/detail?id=${item.itemId}'" style="cursor: pointer;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-2">
                                ...
                                <small class="text-muted">Wait: ${item.timeAgo}</small>
                            </div>
                            <p class="card-text text-muted small mt-2 text-truncate">${item.sellerNickname}</p>
                            <p class="card-text text-secondary small">📍 ${item.dongName}</p>
                        </div>
                    </div>
                </div>
            </c:forEach>
